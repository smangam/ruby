...
def mainmenu
 ...
 Puppet Run
   ...
   36: manually install ncm: /opt/rim/install-scripts/smarts/ncm/9.4.1/doNCMInstallation.sh DS /opt/rim/install-scripts/smarts/ncm/9.4.1/silent-install.properties 15
 Post Puppet Run
